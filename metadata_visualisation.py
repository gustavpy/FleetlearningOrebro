...
#Skapar en dictionary "figs" och fyller den med separata pie chart-figurer baserade på kolumnerna i DataFrame "metadata.csv"
figs = {}
...
app.layout = html.Div([
    ...
    dcc.Graph(id='scatter-map',figure=densitymap),])
...
def update_pie_charts(clickData_country_code, clickData_road_condition, clickData_scraped_weather, clickData_time_of_day, clickData_road_type,clickData_collection_car):
    ...
    return updated_figs['country_code'], updated_figs['road_condition'], updated_figs['scraped_weather'], updated_figs['time_of_day'], updated_figs['road_type'],updated_figs['collection_car']
